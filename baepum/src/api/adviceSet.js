export const adviceSet = [
    ...
    },
    {
      id: 49,
      author: "찰리 채플린",
      authorProfile: "영국 출신 코미디언, 배우, 영화 감독",
      message: "인생은 가까이서 보면 비극이지만, 멀리서 보면 희극이다.",
    },
    {
      id: 50,
      author: "헬렌 켈러",
      authorProfile: "미국 작가, 사회운동가, 강연가",
      message: "세상은 고통으로 가득하지만, 그것을 극복하는 사람들로도 가득하다.",
    },
    {
      id: 51,
      author: "헨리 포드",
      authorProfile: "미국 자동차 산업의 개척자, 포드 자동차 창립자",
      message: "당신이 할 수 있다고 생각하든 할 수 없다고 생각하든, 당신이 옳다.",
    },
    {
      id: 52,
      author: "윈스턴 처칠",
      authorProfile: "영국 총리, 정치가",
      message:
    ...
    },
    {
      id: 56,
      author: "간디",
      authorProfile: "인도 독립운동가, 정치 지도자",
      message: "당신이 세상에서 보고 싶은 변화가 되세요.",
    },
    {
      id: 57,
      author: "마하트마 간디",
      authorProfile: "인도 독립운동 지도자",
      message: "인간의 위대함은 자신의 삶을 변화시키는 능력에 있다.",
    },
    {
      id: 58,
      author: "베토벤",
      authorProfile: "독일 작곡가, 피아니스트",
      message: "음악은 인간의 내면으로부터 나오는 폭발이다.",
    },
    {
      id: 59,
      author: "프랭클린 D. 루즈벨트",
      authorProfile: "미국 제32대 대통령",
      message: "우리가 두려워할 유일한 것은 두려움 그 자체다.",
    },
  ...
  
    {
      id: 61,
      author: "스티브 잡스",
      authorProfile: "미국 기업가, 애플 공동 창립자",
      message:
    ...
    },
    {
      ...
      author: "에이브러햄 링컨",
      authorProfile: "미국 16대 대통령",
      message: "자유는 진리를 말할 수 있는 권리다.",
    },
    {
      id: 63,
      author: "헨리 포드",
      authorProfile: "미국 자동차 산업의 개척자, 포드 자동차 창립자",
      message: "실패는 단지 다시 시작할 수 있는 기회다. 이번에는 더 현명하게.",
    },
    {
      id: 64,
      author: "마크 트웨인",
      authorProfile: "미국 작가, 유머리스트",
      message:
    ...
    },
    {
      id: 65,
      author: "셰익스피어",
      authorProfile: "영국 극작가, 시인",
      message: "지혜는 고난 속에서 배운다.",
    },
    {
      id: 66,
      author: "소크라테스",
      authorProfile: "고대 그리스 철학자",
      message: "너 자신을 알라.",
    },
    {
      id: 67,
      author: "파블로 피카소",
      authorProfile: "스페인 화가, 조각가",
      message:
    ...
    },
    {
      ...
      author: "헬렌 켈러",
      authorProfile: "미국 작가, 사회운동가, 강연가",
      message: "눈을 뜨고도 어둠 속에 사는 것은 참을 수 없다.",
    },
    {
      id: 70,
      author: "갈릴레오 갈릴레이",
      authorProfile: "이탈리아 천문학자, 물리학자, 철학자",
      message: "어떤 진리라도 그것을 밝히는 자는 항상 외로움을 견뎌야 한다.",
    },
    {
      id: 71,
      author: "나폴레옹 보나파르트",
      authorProfile: "프랑스 군사 지도자, 프랑스 황제",
      message: "승리는 가장 끈질긴 자의 것이다.",
    },
    {
      id: 72,
      author: "마이클 조던",
      authorProfile: "미국 농구 선수",
      message:
    ...
    },
    {
      id: 74,
      author: "프리드리히 니체",
      authorProfile: "독일 철학자",
      message: "나를 죽이지 못하는 고통은 나를 더 강하게 만든다.",
    },
    {
      id: 75,
      author: "찰스 디킨스",
      authorProfile: "영국 소설가",
      message: "가장 어두운 순간이 지나야 새벽이 온다.",
    },
    {
      id: 76,
      author: "앨버트 아인슈타인",
    ...
    },
    {
      id: 77,
      author: "버락 오바마",
      authorProfile: "미국 44대 대통령",
      message: "우리는 변화를 믿어야 한다.",
    },
    {
      id: 78,
      author: "오프라 윈프리",
      authorProfile: "미국 방송인, 자선가",
      message: "성공이란 자신이 진정으로 좋아하는 일을 하면서 누리는 행복이다.",
    },
    {
      id: 79,
      author: "버지니아 울프",
      authorProfile: "영국 소설가, 에세이스트",
      message: "내면의 평화는 진정한 자유의 첫 번째 단계이다.",
    },
    {
      id: 80,
      author: "윈스턴 처칠",
    ...
    },
    {
      id: 81,
      author: "미겔 데 세르반테스",
      authorProfile: "스페인 작가",
      message: "그 사람이 읽은 책과 사귄 친구를 보면 그 사람을 알 수 있다.",
    },
    {
      id: 82,
      author: "알프레드 테니슨",
      authorProfile: "영국 시인",
      message: "미래는 준비하는 사람에게 달려 있다.",
    },
    {
      id: 83,
      author: "벤저민 프랭클린",
      authorProfile: "미국 정치가, 과학자",
      message: "일찍 자고 일찍 일어나는 것이 건강, 부, 그리고 지혜의 비결이다.",
    },
    {
      id: 84,
      author: "루이 파스퇴르",
      authorProfile: "프랑스 생물학자, 화학자",
      message: "우연은 준비된 마음에게만 미소 짓는다.",
    },
    {
      id: 85,
      author: "마이클 앤젤로",
      authorProfile: "이탈리아 르네상스 시대 화가, 조각가",
      message: "나는 항상 나의 최고의 걸작을 향해 나아가고 있다.",
    },
    {
      id: 86,
      author: "넬슨 만델라",
      authorProfile: "남아프리카 공화국의 정치가, 인권 운동가",
      message: "언제나 불가능해 보이던 일도 이루어지기 전까지는 그렇다.",
    },
    {
      id: 87,
      author: "마이클 앤젤로",
    ...
    },
    {
      id: 89,
      author: "빈센트 반 고흐",
      authorProfile: "네덜란드 화가",
      message: "위대한 일은 작은 일들의 축적으로 이루어진다.",
    },
    {
      id: 90,
      author: "오프라 윈프리",
      authorProfile: "미국 방송인, 자선가",
      message: "우리는 자신을 스스로 정의하는 사람들이다.",
    },
    {
      id: 91,
      author: "니콜라 테슬라",
      authorProfile: "발명가, 전기 공학자",
      message: "미래는 전기에 달려 있다.",
    },
    {
      id: 92,
      author: "J.K. 롤링",
      authorProfile: "영국 소설가, 해리포터 시리즈의 저자",
      message: "우리가 진정으로 두려워해야 할 것은 두려움 그 자체이다.",
    },
    {
      id: 93,
      author: "찰리 채플린",
    ...
    },
    {
      id: 105,
      author: "토마스 에디슨",
      authorProfile: "미국 발명가, 사업가",
      message: "천재는 1%의 영감과 99%의 땀이다.",
    },
    {
      id: 106,
      author: "스티브 잡스",
